	...
	const questions = [
		...
		},
		{
			...
			answerOptions: [
				...
				{
					answerText: "Не менее 50 км/ч и не более 70 км/ч. 3",
					isCorrect: false,
				},
				{
		...
		},
		{
			...
			answerOptions: [
				{
					answerText: "Движение любых транспортных средств.",
					isCorrect: false,
				},
				{
					answerText:
				...
				{
					answerText: "Движение механических транспортных средств.",
					isCorrect: true,
				},
			],
		},
		...
		},
		{
			...
			answerOptions: [
				...
				{
					answerText: "Непосредственно после переезда.",
					isCorrect: true,
				},
		...
		},
		{
			...
			answerOptions: [
				{
					answerText: "Менее 70 м на протяжении 100 м.",
					isCorrect: false,
				},
				{
					answerText: "Не менее 70 м на протяжении 100 м.",
					isCorrect: true,
				},
		...
		},
		{
			...
			answerOptions: [
				...
				{
					answerText: "Прямо, налево или в обратном направлении.",
					isCorrect: false,
				},
			],
		},
		...
		},
		{
			...
			answerOptions: [
				{
					answerText:
						"O приближении к железнодорожному переезду с тремя путями.",
					isCorrect: false,
				},
				{
					answerText:
						"О наличии через 150300 м железнодорожного переезда без шлагбаума.",
					isCorrect: true,
				},
				{
					answerText:
						"О наличии через 50100 м железнодорожного переезда.",
					isCorrect: false,
				},
			],
		},
